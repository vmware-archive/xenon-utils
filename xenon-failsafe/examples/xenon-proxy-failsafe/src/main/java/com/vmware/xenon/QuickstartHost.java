...
import com.vmware.xenon.failsafe.FailsafeServiceHost;
import com.vmware.xenon.common.ServiceHost;
import com.vmware.xenon.services.common.RootNamespaceService;
import com.vmware.xenon.ui.UiService;

public class QuickstartHost extends FailsafeServiceHost {
    /**
    ...
    public ServiceHost start() throws Throwable {
        ...
        super.startService(new ProxyService());
        super.startService(new ForwardService());
        super.startService(new JoinService());
        super.startService(new SlowService());
        super.startService(new FailService());
