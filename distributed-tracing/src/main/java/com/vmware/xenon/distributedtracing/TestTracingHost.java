...
public class TestTracingHost extends ServiceHost {
    ...
    public ServiceHost start() throws Throwable {
        ...
        try (ActiveSpan activeSpan = this.otTracer.buildSpan("TestTracingHost.start").startActive()) {
            ...
            // queries to the root (/)
            try (ActiveSpan nsSpan = this.otTracer.buildSpan("startNamespace").startActive()) {
                super.startService(new RootNamespaceService());
            }
            try (ActiveSpan exampleSpan = this.otTracer.buildSpan("startExampleServices").startActive()) {
