 ...
 *
 * run host tests with authorization enabled
 */
public class FailsafeServiceAuthorizedHostTest extends FailsafeServiceHostTest {
    @Override
    public ServiceHost startHost(String[] stringArgs, ServiceHost.Arguments args) throws Throwable {
        ...
        return super.startHost(stringArgs, args);
    }
}
